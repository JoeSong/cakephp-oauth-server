 ...
 */
	public function __construct(ComponentCollection $collection, $settings = array()) {
		...
		$this->OAuthServerClient = ClassRegistry::init(array('class' => 'OAuth.OAuthServerClient', 'alias' => 'OAuthServerClient'));
 ...
 */
	public function checkClientCredentials($client_id, $client_secret = null) {
		...
		$client = $this->OAuthServerClient->find('first', array(
			'conditions' => $conditions,
			'recursive' => -1
		));
		if ($client) {
			return $client['OAuthServerClient'];
		};
		return false;
	}
